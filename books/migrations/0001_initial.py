    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_year', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1000), books.models.validate_year_not_in_future])),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('publication_year', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1000), books.models.validate_year_not_in_future])),
